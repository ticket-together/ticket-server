...
public class ReviewServiceImpl implements ReviewService{
    ...
    public List<ReviewInfoDto> searchReviewBySeat(Long hallId, ReviewSearchCondition condition) throws BaseException {
        ...
        return reviewSearchRepository.searchBySeat(condition);
    ...
    // 리뷰 수정
    @Override
    public ReviewDto.addResponse updateReview(Long reviewId, ReviewDto.updateRequest requestDto) throws BaseException{
        try {
