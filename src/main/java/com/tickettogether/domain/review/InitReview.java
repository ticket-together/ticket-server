package com.tickettogether.domain.review;
...
public class InitReview {
    ...
    static class InitReviewService {
        ...
        public void init() {
            ...
            Member member1 = new Member("yy@", "abc1", "영현", "profile1", GUEST);
            Member member2 = new Member("yyhhh@", "abchh1", "영현h", "profile1h", GUEST);

            Hall hall1 = new Hall("서울경기장");
            Hall hall2 = new Hall("잠실체조경기장");
            ...
            Review review4 = new Review(member1, hall2, BigDecimal.valueOf(1), "content3", "2", "A", "12", "21");
